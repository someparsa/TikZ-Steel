...
EXAMPLES = examples/cfs-gallery.tex examples/hrs-gallery.tex examples/style-customization.tex
TESTS = tests/smoke-cfs.tex tests/smoke-hrs.tex tests/smoke-keyval.tex
