...
\keyname{top flange}, \keyname{bottom flange} & 75 & Independent CFS flange widths overriding \keyname{flange} \\
\keyname{left flange}, \keyname{right flange} & 35 & Hat-section flange widths \\
\keyname{lip} & 20 & Common CFS lip length used when top/bottom values are not supplied \\
\keyname{top lip}, \keyname{bottom lip} & 20 & Independent CFS lip lengths overriding \keyname{lip} \\
...
\keyname{tikzSections/concrete} & RC concrete outline and fill \\
\keyname{tikzSections/rebar} & RC rebar circles \\
\keyname{tikzSections/tie} & RC tie/stirrup outline \\
\bottomrule
\end{longtable}
...
\keyname{bottom lip=0}, to suppress the lips. The named unlipped commands are
convenience wrappers around the same general channel/zee handlers.
...
\midrule
\CommandSummary{TikZSectionsChannel}{Unlipped channel}{\keyname{depth}, \keyname{flange} or top/bottom flanges, \keyname{thickness}, \keyname{radius}}{CFS}
\CommandSummary{TikZSectionsLippedChannel}{Lipped channel}{\keyname{depth}, \keyname{flange}/top/bottom flanges, \keyname{lip}/top/bottom lips}{CFS}
...
\CommandSummary{TikZSectionsZee}{Zee section}{\keyname{depth}, \keyname{flange} or top/bottom flanges, \keyname{thickness}, \keyname{radius}}{CFS}
\CommandSummary{TikZSectionsLippedZee}{Lipped zee section}{\keyname{depth}, \keyname{flange}/top/bottom flanges, \keyname{lip}/top/bottom lips}{CFS}
...
\ReferenceRow
  ...
  {\TikZSectionsLippedChannel[depth=180, flange=55, lip=18, thickness=2, radius=4, scale=0.03]}
  {}
  {\ShapePreview{\TikZSectionsLippedChannel[depth=180, flange=55, lip=18, thickness=2, radius=4, scale=0.03]}}
...
\ReferenceRow
  ...
  {\TikZSectionsStiffenedChannel[depth=180, top flange=55, top lip=18, bottom flange=60, bottom lip=20, stiffener position=0.55, thickness=2, radius=4, scale=0.03]}
  {}
  {\ShapePreview{\TikZSectionsStiffenedChannel[depth=180, top flange=55, top lip=18, bottom flange=60, bottom lip=20, stiffener position=0.55, thickness=2, radius=4, scale=0.03]}}
...
\ReferenceRow
  ...
  {\keyname{depth}, \keyname{flange}, \keyname{lip}, \keyname{thickness}, \keyname{radius}}
  {\TikZSectionsLippedZee[depth=180, flange=55, lip=18, thickness=2, radius=4, scale=0.03]}
  {}
  {\ShapePreview{\TikZSectionsLippedZee[depth=180, flange=55, lip=18, thickness=2, radius=4, scale=0.03]}}
...
\ReferenceRow
  ...
  {\TikZSectionsSigma[depth=180, top flange=55, top lip=18, bottom flange=60, bottom lip=20, thickness=2, radius=4, scale=0.03]}
  {}
  {\ShapePreview{\TikZSectionsSigma[depth=180, top flange=55, top lip=18, bottom flange=60, bottom lip=20, thickness=2, radius=4, scale=0.03]}}
